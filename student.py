...
# Testing Connection 
"""
conn = mysql.connector.connect(username='root', password='PFH#23kgrw9',host='localhost',database='face_recognition',port=3306)
cursor = conn.cursor()
...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","CSE","CIVIL","Mechanical","EEE","EC")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","B.tech","BCA","M.tech","MBA","Diploma")
        cou_combo.current(0)
        ...
        year_combo["values"]=("Select Year","2017-21","2018-22","2019-23","2020-24","2021-25","2016-18","2018-20","2020-22","2016-19","2017-20","2018-21")
        ...
        search_combo["values"]=("Select","Roll-No","Registration-No")
